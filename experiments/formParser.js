  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        switch(vars[form.type].def){
            ...
            return "<label class=\""+form.type+"\"><input type=\"radio\" name=\""+form.name+"\" value=\""+answer.value+"\">"+answer.value+"</label>"
        }).join('\n')
        break;
            default:
        retString="<label class=\""+form.type+"\">"+form.name+"<input type=\""+vars[form.type].def+"\" name=\""+form.name+"\"/></label>"
        }
        return retString;
